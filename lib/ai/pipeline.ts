  ...
  const userPrompt =
    REPORT_LOCALE === "en"
      ? [
          ...
          "  - daily_overview: **80-150 word** paragraph focused on tech signals",
          "  - tech_briefs: **3-5** tech BriefItems",
          "  - finance_briefs: [] (always empty array)",
          "  - politics_briefs: [] (always empty array)",
      ...
      : [
          ...
          "  - daily_overview: **80-150 字** 的当日总览段落，一段话覆盖技术核心信号",
          "  - tech_briefs: **3-5 条** 科技 BriefItem",
          "  - finance_briefs: [] （固定空数组）",
          "  - politics_briefs: [] （固定空数组）",
